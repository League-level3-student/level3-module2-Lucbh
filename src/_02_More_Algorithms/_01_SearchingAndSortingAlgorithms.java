...
public class _01_SearchingAndSortingAlgorithms {
	...
	public void testFindMaxiumum() throws Exception {
		List<Double> peeps = Arrays.asList(new Double[] { 10.0, 6.2, 3.4, 6.2, 5.0, 5.5, 4.7, 6.2, 3.4, 4.2, 5.0, 4.5, 5.1, 60.0 });
		assertEquals(60.0, Algorithms.findTallest(peeps), 0.0);
	}
